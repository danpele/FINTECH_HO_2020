...
for (i in (1:n_waves))
{
 ...
 # LR[i,5]<-1-pchisq(mod1$null.deviance-mod1$deviance,df=1)
 # LR[i,6]<-1-pchisq(mod2$null.deviance-mod2$deviance,df=1)
 # LR[i,7]<-1-pchisq(mod3$null.deviance-mod3$deviance,df=1)
