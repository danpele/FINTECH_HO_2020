...
### FRM_Quantile_Regression has been created by Andrija Mihoci (FRM Financial Risk Meter)
### Authors: Youjuan Li, Ji Zhu (L1-Norm Quantile Regression), University of Michigan (jizhu@umich.edu)
### Date: 07/01/2006
#######################################################################
